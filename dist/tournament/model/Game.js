...
var Game = (function () {
    function Game(tournament, session, socket, ui, options) {
    ...
    Game.prototype.handleGameEnd = function (winner, playerDisconnected) {
    ...
    Game.prototype.sessionEnd = function () {
    ...
    Game.prototype.log = function (message, skipRender) {
