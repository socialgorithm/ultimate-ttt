...
declare module 'blessed' {
    ...
    export module Widgets {
        ...
        export abstract class Node implements IHasOptions<INodeOptions>, IDestroyable {
        ...
        export class Screen extends NodeWithEvents implements IHasOptions<IScreenOptions> {
             ...
             */
            spawn(file: string, args: string[], options: NodeChildProcessExecOptions): any;
            /**
             * Spawn a process in the foreground, return to blessed app after exit. Executes callback on error or exit.
             */
            exec(file: string, args: string[], options: NodeChildProcessExecOptions, callback: Function): any;
            /**
